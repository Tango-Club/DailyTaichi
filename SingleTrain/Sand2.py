# based on MPM128
# https://gist.github.com/rexwangcc/abe4c29bb4c137ce9411b41f98ff2f77
...
print(
    "[Hint] Use left/right mouse bottons to attract/repel. Press R to reset."
)
gui = ti.GUI("Sand2", res=512, background_color=0x112F41)
reset()
gravity[None] = [0, -1]
...
for frame in range(20000):
    ...
    gui.circles(x.to_numpy(),
                radius=1,
                palette=[0xFFE4C4, 0xDAA520, 0xF5DEB3],
